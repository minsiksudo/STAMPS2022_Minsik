...
#setting github token....                
        #install.packages("usethis")
                ...
                #credentials::set_github_pat("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")
                #usethis::edit_r_environ()
                #remotes::install_github("https://github.com/ailurophilia/logsum", force = T)
                #remotes::install_github("https://github.com/statdivlab/radEmu")
library(radEmu)
